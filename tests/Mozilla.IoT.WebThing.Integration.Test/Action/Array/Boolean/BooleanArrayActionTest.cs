...
namespace Mozilla.IoT.WebThing.Integration.Test.Action.Array.Boolean
{
    public class BooleanArrayActionTest : AbstractArrayActionTest<bool>
    {
        ...
        protected override IEnumerable<JsonElement> CreateInvalidJson()
        {
            ...
            yield return JsonSerializer.Deserialize<JsonElement>($@"{{ ""action"": {{ ""input"": {{ ""value"": {sb} }} }} }}").GetProperty("action");;
