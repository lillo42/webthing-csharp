...
{
    public class PostActionsMiddlewareTest
    {
        ...
        public PostActionsMiddlewareTest()
        {
        ...
        public async Task Invoke_Single_NotFound()
        {
            ...
            var middleware = new PostActionsMiddleware(_next, _factory, thingType);
        ...
        {
            var thing = _fixture.Create<Thing>();
            string actionName1 = _fixture.Create<string>();
            
            thing.AddAvailableAction<TestAction>(actionName1);

            await thing.PerformActionAsync(actionName1, null, CancellationToken.None);
            
            string actionNam2 = _fixture.Create<string>();
            
            thing.AddAvailableAction<TestAction>(actionNam2);

            await thing.PerformActionAsync(actionNam2, null, CancellationToken.None);
        ...
        public async Task Invoke_Multi()
        {
            ...
            string actionName2 = _fixture.Create<string>();
            
            thing.AddAvailableAction<TestAction>(actionName2);

            await thing.PerformActionAsync(actionName2, null, CancellationToken.None);
