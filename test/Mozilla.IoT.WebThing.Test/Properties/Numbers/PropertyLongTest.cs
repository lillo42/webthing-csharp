...
{
    public class PropertyLongTest
    {
        private readonly NumberThing _thing;
        private readonly Fixture _fixture;
        
        public PropertyLongTest()
        {
        ...
        #region No Nullable 
        private PropertyLong CreateNoNullable(long[]? enums = null, long? min = null, long? max = null, long? multipleOf = null)
            => new PropertyLong(_thing,
                thing => ((NumberThing)thing).Number,
                (thing, value) => ((NumberThing)thing).Number = (long)value,
        ...
        private PropertyLong CreateNullable(long[]? enums = null, long? min = null, long? max = null, long? multipleOf = null)
            => new PropertyLong(_thing,
                thing => ((NumberThing)thing).NullableNumber,
                (thing, value) => ((NumberThing)thing).NullableNumber = (long?)value,
