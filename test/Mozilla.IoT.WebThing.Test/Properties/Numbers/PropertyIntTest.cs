...
{
    public class PropertyIntTest
    {
        private readonly NumberThing _thing;
        private readonly Fixture _fixture;
        
        public PropertyIntTest()
        {
        ...
        #region No Nullable 
        private PropertyInt CreateNoNullable(int[]? enums = null, int? min = null, int? max = null, int? multipleOf = null)
            => new PropertyInt(_thing,
                thing => ((NumberThing)thing).Number,
                (thing, value) => ((NumberThing)thing).Number = (int)value,
        ...
        private PropertyInt CreateNullable(int[]? enums = null, int? min = null, int? max = null, int? multipleOf = null)
            => new PropertyInt(_thing,
                thing => ((NumberThing)thing).NullableNumber,
                (thing, value) => ((NumberThing)thing).NullableNumber = (int?)value,
