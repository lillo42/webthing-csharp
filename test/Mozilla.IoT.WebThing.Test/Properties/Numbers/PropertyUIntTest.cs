...
{
    public class PropertyUIntTest
    {
        private readonly NumberThing _thing;
        private readonly Fixture _fixture;
        
        public PropertyUIntTest()
        {
        ...
        #region No Nullable 
        private PropertyUInt CreateNoNullable(uint[]? enums = null, uint? min = null, uint? max = null, uint? multipleOf = null)
            => new PropertyUInt(_thing,
                thing => ((NumberThing)thing).Number,
                (thing, value) => ((NumberThing)thing).Number = (uint)value,
        ...
        {
            var values = _fixture.Create<uint[]>();
        ...
        [InlineData(11)]
        [InlineData(10)]
        public void SetNoNullableWithMinValue(uint value)
        {
        ...
        [InlineData(9)]
        [InlineData(10)]
        public void SetNoNullableWithMaxValue(uint value)
        {
        ...
        public void TrySetNoNullableWithEnumValue()
        {
            var values = _fixture.Create<uint[]>();
            var property = CreateNoNullable(values);
            var jsonElement = JsonSerializer.Deserialize<JsonElement>($@"{{ ""input"": {_fixture.Create<uint>()} }}");
            property.SetValue(jsonElement.GetProperty("input")).Should().Be(SetPropertyResult.InvalidValue);
        }
        ...
        [InlineData(8)]
        [InlineData(9)]
        public void TrySetNoNullableWithMinValue(uint value)
        {
            var property = CreateNoNullable(min: 10);
            var jsonElement = JsonSerializer.Deserialize<JsonElement>($@"{{ ""input"": {value} }}");
            property.SetValue(jsonElement.GetProperty("input")).Should().Be(SetPropertyResult.InvalidValue);
        ...
        [InlineData(12)]
        [InlineData(11)]
        public void TrySetNoNullableWithMaxValue(uint value)
        {
            var property = CreateNoNullable(max: 10);
            var jsonElement = JsonSerializer.Deserialize<JsonElement>($@"{{ ""input"": {value} }}");
            property.SetValue(jsonElement.GetProperty("input")).Should().Be(SetPropertyResult.InvalidValue);
        ...
        private PropertyUInt CreateNullable(uint[]? enums = null, uint? min = null, uint? max = null, uint? multipleOf = null)
            => new PropertyUInt(_thing,
                thing => ((NumberThing)thing).NullableNumber,
                (thing, value) => ((NumberThing)thing).NullableNumber = (uint?)value,
        ...
        [InlineData(11)]
        [InlineData(10)]
        public void SetNullableWithMinValue(uint value)
        {
        ...
        [InlineData(9)]
        [InlineData(10)]
        public void SetNullableWithMaxValue(uint value)
        {
        ...
        [InlineData(8)]
        [InlineData(9)]
        public void TrySetNullableWithMinValue(uint value)
        {
            var property = CreateNullable(min: 10);
            var jsonElement = JsonSerializer.Deserialize<JsonElement>($@"{{ ""input"": {value} }}");
            property.SetValue(jsonElement.GetProperty("input")).Should().Be(SetPropertyResult.InvalidValue);
        ...
        [InlineData(12)]
        [InlineData(11)]
        public void TrySetNullableWithMaxValue(uint value)
        {
            var property = CreateNullable(max: 10);
            var jsonElement = JsonSerializer.Deserialize<JsonElement>($@"{{ ""input"": {value} }}");
            property.SetValue(jsonElement.GetProperty("input")).Should().Be(SetPropertyResult.InvalidValue);
        ...
        public class NumberThing : Thing
        {
            ...
            public uint? NullableNumber { get; set; }
        }
    }
}
