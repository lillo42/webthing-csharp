...
{
    public class GetActionByIdTest
    {
        ...
        private readonly ILogger<GetActionById> _logger;
        private readonly IThingActivator _thingActivator;

        public GetActionByIdTest()
        {
            _fixture = new Fixture();

            _logger = Substitute.For<ILogger<GetActionById>>();
            ...
            _service.GetService(typeof(ILogger<GetActionById>))
                .Returns(_logger);
        ...
        public async Task Invoke_Should_ReturnNotFound_When_ThingNotExists()
        {
            ...
            await GetActionById.Invoke(_httpContext);
        ...
        public async Task Invoke_Should_Return200_When_ActionContainsAction()
        {
            ...
            writer.WriteAsync(Arg.Any<Dictionary<string, object>>(), cancel)
