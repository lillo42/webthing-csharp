...
{
    public class ParameterByteTest
    {
        private readonly Fixture _fixture;
        
        public ParameterByteTest()
        {
            _fixture = new Fixture();
        }
        
        #region No Nullable 
        private static ParameterByte CreateNoNullable(byte[]? enums = null, byte? min = null, byte? max = null, byte? multipleOf = null)
            => new ParameterByte(false, min, max, multipleOf, enums);
        ...
        private ParameterByte CreateNullable(byte[]? enums = null, byte? min = null, byte? max = null, byte? multipleOf = null)
            => new ParameterByte(true, min, max, multipleOf, enums);
