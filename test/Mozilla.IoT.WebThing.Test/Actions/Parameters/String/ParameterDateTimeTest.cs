...
{
    public class ParameterDateTimeTest
    {
        private readonly Fixture _fixture;

        public ParameterDateTimeTest()
        {
            _fixture = new Fixture();
        }
        
        #region No Nullable
        private static ParameterDateTime CreateNoNullable(DateTime[]? enums = null)
            => new ParameterDateTime(false, enums);
        ...
        private static ParameterDateTime CreateNullable(DateTime[] enums = null)
            => new ParameterDateTime(true, enums);
