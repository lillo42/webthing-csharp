...
namespace Mozilla.IoT.WebThing.Test.Factory
{
    public class SystemTexJsonConvertibleFactoryTest
    {
        ...
        [InlineData(typeof(IEnumerable<object>), typeof(SystemTexJsonArrayConvertible))]
        [InlineData(typeof(IList<object>), typeof(SystemTexJsonArrayConvertible))]
        [InlineData(typeof(List<object>), typeof(SystemTexJsonArrayConvertible))]
        [InlineData(typeof(LinkedList<object>), typeof(SystemTexJsonArrayConvertible))]
        [InlineData(typeof(HashSet<object>), typeof(SystemTexJsonArrayConvertible))]
        [InlineData(typeof(ISet<object>), typeof(SystemTexJsonArrayConvertible))]
        [InlineData(typeof(ICollection<object>), typeof(SystemTexJsonArrayConvertible))]
